...
return [
    ...
    'about_content_footer_1' => 'エクソソームと共に',
    'about_content_footer_2' => '皮膚本来の美しさと活力を取り戻してください',
...
we embody the brand\'s philosophy of presenting new possibilities in skin regeneration and anti-aging.',
    ...
    'cibi_brightness' => 'Utilize colors according to brightness',
    'cibi_saturation' => 'Utilize colors according to saturation',
    'cibi_background' => 'Leveraging Black-and-White Background Colors',
    'core_raw' => 'Raw material properties only',
    'confirm_ordersheet' => 'Do you want to go to the order page?',
    'success_cart' => 'Successfully added to shopping cart',
    'confirm_checkout' => 'I have confirmed the terms and conditions and order details, and agree to the provision of information.',
    'checkout_recipient_holder' => 'Please enter the recipient name',
    'checkout_phone_holder' => 'Please enter your mobile phone number',
    'checkout_addr_search_holder' => 'Please use address search',
    'checkout_account_name_holder' => 'Please enter the depositor’s name',
    'checkout_card_name_holder' => 'Please enter the cardholder name',
    'checkout_card_number_holder' => 'Please enter your card number.',
    'checkout_card_pw_holder' => 'Please enter your two-digit card password.',
    'checkout_card_birth_holder' => 'Please enter your date of birth. Ex) 870204',
    'checkout_error_alert' => 'Please enter the missing values.',
