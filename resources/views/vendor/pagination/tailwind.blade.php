                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-exomere bg-white border border-gray-300 cursor-default leading-5 ">{{ $page }}</span>
                                    </span>
                                @else
