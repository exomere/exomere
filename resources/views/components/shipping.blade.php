<div>
    ...
    <div
        ...
        @if(app()->getLocale() == 'ko')
            ...
            <div>
                ...
                ④ 상품 중 스프레이류, 방향제, 염모제는 항공 운송 상 안전 상의 이유로 항공 운송 거부 품목에 해당되며, 제주 및 도서 지역은 배편을
                이용하여 배송되며,
                배송
                기간이
                추가될 수 있습니다.
            ...
            <div>
                ...
                ① 미개봉, 미사용 상태(QR 스티커가 뜯어지지 않은 상태)의 손상 및 변질이 없는 상품만 반품이 가능하며 사용하신 상품은 반품이 일체 허용되지
                않습니다.

                ② 키트, 프로모션, 패키지 상품을 반품하는 경우, 또는 사은품이 함께 지급되는 상품을 반품하는 경우, 주문한 상품 외에 함께 제공된 증정 상품
                및 사은품
                등을
                포함하여
                ...
                ② 상품 내용이 표시/광고와 다르거나 상품하자의 경우 상품 수령 후 3개월 이내 혹은 그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내
                (반품 배송비
                회사
                부담)
    ...
    @else
        <div>
            ...
            However, order cancellations are only possible while the order is in the "payment
            completed"
            status. If the order is in the "preparing for shipment" or "in transit" status, you
            must
        ...
        <div>
            ...
            ② A shipping fee of 3,000 KRW applies for purchases under 50,000 KRW. (No additional
            fees
            for remote or island areas)

            ※ Basic shipping fees may be subject to change, and changes will be notified at the
            time of
            payment for the product.

            <strong>3. Delivery Period</strong>

            ① Orders completed by 4 PM will be shipped on the same day. Orders completed after 4
            PM will
            be shipped the next business day. Delivery takes about 2-3 days after shipment but
            may be
            delayed due to logistics conditions of the courier.

            ② Orders placed at the end of the month, the beginning of the month, during
            holidays, or for
            ...
            ④ Products such as sprays, air fresheners, and hair dyes are restricted from air
            transport
            due to safety concerns and will be shipped via sea transport to Jeju and island
            areas, which
            may result in additional delivery time.

            ⑤ Deliveries to military bases or areas restricted to civilians may not be possible,
            so
        ...
        <div>
            ...
            ① Only unopened and unused products (with QR stickers intact) that are not damaged
            or
            deteriorated can be returned. Used products are not eligible for return.

            ② When returning kits, promotional, or package products, or products with
            complimentary
            ...
            ② If more than 14 days have passed since delivery for reasons of buyer’s simple
            change of
            mind.
            ...
            ⑥ If the product's value has significantly depreciated over time, making resale
            difficult.

            <strong>3. Return Request Period</strong>

            ① Simple change of mind: Within 14 days after receiving the product (return shipping
            fee to
            be borne by the buyer).

            ② Product discrepancy or defect: Within 3 months of receiving the product, or within
            30 days
            from the date the issue was discovered (return shipping fee to be borne by the
            company).
            ...
            (For free shipping, the return shipping fee will be 6,000 KRW, as the initial
            shipping fee
            is included in the payment amount.)

            <strong>5. Return Procedure</strong>

            ① Confirm expected refund amount and other details before completing the return
            request.

            ② CJ Logistics will collect the product.

            ③ After confirming the condition of the returned product, a refund will be processed
            within
            3 business days (for card payments, additional time may be required due to card
            company
            procedures).

            ※ It may take 2-3 days for inspection and confirmation after the product is
            received.
        </div>
