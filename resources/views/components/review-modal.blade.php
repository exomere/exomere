...
<div id="review-modal" tabindex="-1" aria-hidden="true"
     class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[51px] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
