            ...
            <section id="philosophy" class="pb-32 lg:pb-40">
                <div class="pt-20 px-4 lg:pl-44">
                    <div class="relative z-30 text-left tracking-tight">
                        <h2 class="text-3xl text-baseColor font-semibold leading-tight mb-3 md:text-4xl"
                ...
                <div
                    class="text-3xl text-baseColor text-center font-semibold leading-tight pt-10
                ...
                <section id="exosome"
                    ...
                    <div class="flex flex-col lg:flex-row">
                        ...
                        <div
                            ...
                            <h2 class="text-3xl text-baseColor font-semibold leading-tight mb-3 whitespace-pre-line  md:text-4xl"
