...
$contents = [
    [
        ...
        'desc' => 'Exomere Halla™는 머리카락보다 1,200배 작은 미세 입자를 통해 유효 성분이 피부에 직접 흡수되어 효과를 극대화합니다. 또한 강력한 항산화 성분을 함유하여 피부건강을 유지하는 데 도움을 주고, 멜라닌 생성을 억제하여 피부톤을 고르게 하고 기미와 잡티를 감소시키는 데 기여하며, 피부에풍부한 영양과 수분을 공급하여 촉촉한 피부를 유지하는 데 도움을 줍니다.',
