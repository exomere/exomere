...
$category = request()->query('category') ?? 'exomere';
        ...
        <section class="max-container padding-y ">
            <div class="bg-white">
                ...
                <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                    <ul class="flex flex-wrap justify-center padding-y -mb-px text-sm lg:text-lg font-medium text-center tracking-tight gap-4"
                        id="tab"
                        role="tablist"
                        ...
                        @foreach($categories as $cate)
                            <li role="presentation">
                                <button class="inline-block p-2 lg:p-4 font-montserrat"
                                        ...
                                        type="button"
                                        role="tab"
                                        data-tabs-target="#{{$cate}}"
                                        aria-controls="{{$cate}}"
                                        aria-selected="{{$cate == $category ? 'true' : 'false'}}"
                                >{{ __('gnb.'.$cate) }}
                                </button>
                            </li>
                        @endforeach
