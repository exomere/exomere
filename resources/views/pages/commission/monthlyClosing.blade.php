...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-5">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" method="post" action="{{route('monthly-closing')}}">
        @csrf
        <label class="col-form-label" style='font-size:16px;' for="start_date">검색일자 : </label>
...
<div class="card">
  <div class="card-header d-flex align-items-center justify-content-between">
    <h5 class="mb-0">월마감 내역</h5> <small class="text-muted float-end"></small>
  </div>
    ...
    <table class="table" >
      <thead>
        <tr>
          ...
          <th rowspan="2" style=' vertical-align: middle;'>마감월</th>

          
          <th rowspan="2" style=' vertical-align: middle;'>직접모집관리금</th>
          <th rowspan="2" style=' vertical-align: middle;'>장려금</th>
          <th rowspan="2" style=' vertical-align: middle;'>지역사무실<br>지원금</th>
          <th rowspan="2" style=' vertical-align: middle;'>교육지원금</th>
          <th rowspan="2" style=' vertical-align: middle;'>인센티브</th>
          <th rowspan="2" style=' vertical-align: middle;'>우수FC기여금</th>
          <th rowspan="2" style=' vertical-align: middle;'>최우수FC기여금</th>
        ...
        @isset($output_data)
            @foreach ($output_data as $data)
                <tr class="align-middle py-2">
                    ...
                    <td><span class="fw-medium">{{ number_format($data['contribution_amount'] )}}</span></td>
                    <td><span class="fw-medium">{{ number_format($data['contribution_amount2'] )}}</span></td>
