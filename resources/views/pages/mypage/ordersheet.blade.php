                                        ...
                                        <div class="row flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <h6 class="flex"><span
                                                            class="total-price">{{number_format($pd_price)}}</span> <span
                                ...
                                <div class="flex items-center mb-4">
                                    <div class="flex gap-10">
                                        <div class="inline-flex items-center">
                                            <label class="relative flex items-center cursor-pointer" for="radio_account">
                                                <input name="payment_type" type="radio" class="checkPaymentType peer h-5 w-5 cursor-pointer appearance-none rounded-full border border-slate-300 checked:border-slate-400 transition-all" id="radio_account" value='account' checked="">
                                            ...
                                            <span class="ml-2 text-slate-600 cursor-pointer text-sm" for="radio_account">계좌이체</label>
                                        </div>
                                        <div class="inline-flex items-center">
                                            <label class="relative flex items-center cursor-pointer" for="radio_card">
                                                <input name="payment_type" type="radio" class="checkPaymentType peer h-5 w-5 cursor-pointer appearance-none rounded-full border border-slate-300 checked:border-slate-400 transition-all" id="radio_card" value='card'>
                                                <span class="absolute bg-slate-800 w-3 h-3 rounded-full opacity-0 peer-checked:opacity-100 transition-opacity duration-200 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"></span>
                                            </label>
                                    ...
                                    <div class="w-full max-w-sm min-w-[240px]">
                                        <div class="relative">
                                            ...
                                            <input type="text"
                                                    ...
                                                    name="card_password"
                                            >
                                            <label class="col-sm-1 col-form-label" for="payment_card_6"> 할부개월 </label>
                                            <br>
                                            <select class="form-select"  name="card_installment">
                                                @for ($i = 1; $i < 13; $i++)
