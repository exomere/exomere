                    ...
                    <div class="py-6">
                        ...
                        <div class="max-w-2xl mx-auto p-4">
                            <div class="flex justify-end mb-4">
                                ...
                                @else
                                    <button onclick="if(confirm('{{ __('messages.require_login') }}')) location.href='{{ route('login') }}'"
                                            class="block border border-solid border-gray-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                            type="button">
                                        {{ __('common.regist_review') }}
                                    </button>
                ...
                <form id="review-form">
                    ...
                    <div class="relative bg-white rounded-lg shadow">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <div class="flex flex-row">
                                <span
                                    class="text-base leading-relaxed text-gray-500 mr-2">{{ __('common.rating') }}</span>
                            ...
                            <input type="text" name="title" class="input" required placeholder="{{ __('messages.subject') }}">
