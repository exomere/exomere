...
@section('title', 'Inquiry - Create')

@section('content')
    <!-- Basic Layout -->
    <div class="row">
        <!-- Basic Layout Form -->
        <form id="inquiryForm" method='post' action="{{ route('erp-board.inquiry.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">1:1 {{__('erp.inquiry')}} {{__('erp.register')}}</h5>
