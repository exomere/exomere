            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">{{__('erp.news')}} {{__('erp.edit')}}</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-1">
                                <select class="form-control" name="category">
                                    <option value="social"  @isset($video->category) @if($video->category == 'social') selected @endif @endisset >{{__('erp.social')}}</option>
                                    <option value="rnd"  @isset($video->category) @if($video->category == 'rnd') selected @endif @endisset >{{__('erp.rnd')}}</option>
                                    <option value="company"  @isset($video->category) @if($video->category == 'company') selected @endif @endisset >{{__('erp.company')}}</option>
                                </select>
                            </div>
                        </div>
                        <!-- Content -->
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">{{__('erp.current_thumbnail')}} :</label>
                            <div class="col-sm-10">
